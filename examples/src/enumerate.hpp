...
public:
	...
	struct iterator {
		...
		iterator(typename Container::iterator non_enumerated_iterator, size_type counter = 0)
		: inner_iter(non_enumerated_iterator), counter_(counter) {}
		...
		typename std::iterator_traits<typename Container::iterator>::value_type& item() { return *inner_iter; }
	...
	struct const_iterator {
		...
		const_iterator(typename Container::const_iterator non_enumerated_iterator, size_type counter = 0)
		: inner_iter(non_enumerated_iterator), counter_(counter) {}
