...
#ifndef OPENCL_WRAPPERS_REGION_HPP_
#define OPENCL_WRAPPERS_REGION_HPP_
...
public:
	 ...
	 */
	template <typename ContiguousContainer, typename = opencl::detail::enable_if_t<
		opencl::detail::is_kinda_like_contiguous_container<ContiguousContainer>::value, void>>
...
#endif // OPENCL_WRAPPERS_REGION_HPP_
